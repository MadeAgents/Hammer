...
OUT_DIR="../checkpoint/train_app_name_reject_2w"

deepspeed --num_gpus $num_gpus src/train.py \
    --deepspeed examples/deepspeed/ds_z2_config.json \
    --stage sft \
    --do_train \
    --model_name_or_path /home/notebook/data/group/model_hub/huggingface/Qwen/Qwen1.5-1.8B-Chat-GPTQ-Int4 \
    --dataset train_app_name_reject_2w \
    --output_dir $OUT_DIR \
    --template qwen \
    --dataset_dir ../data \
